...
export type ProductQuery = { __typename?: 'Query', products?: { __typename?: 'MarketItem', name: string, ID: number, slug: string, description: string, rating: number, reviews: number, likes: number, views: number, subcategory: string, createdAt: any, updatedAt: any, user?: { __typename?: 'User', name: string, phone: string } | null, defaultVariant: { __typename?: 'MarketItemVariant', ID: number }, defaultPhoto: { __typename?: 'GalleryItem', ID: number }, variants: Array<{ __typename?: 'MarketItemVariant', ID: number, photoID: number, name: string, price: string, stock: number, isDisabled: boolean, isLimitedByStock: boolean }>, media: Array<{ __typename?: 'GalleryItem', ID: number, URL: string, caption: string, annotation: string, createdAt: any, updatedAt: any }>, category?: { __typename?: 'MarketItemCategory', name: string, slug: string } | null } | null };
...
export type VisitStatsQueryVariables = Exact<{ [key: string]: never; }>;


export type VisitStatsQuery = { __typename?: 'Query', stats: { __typename?: 'VisitorStatistic', total: number, today: number, yesterday: number, thisWeek: number, lastWeek: number, thisMonth: number, lastMonth: number } };
